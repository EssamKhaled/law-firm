...
class Auth extends MY_Controller {
    ...
    function create_user() {
        ...
        if ($this->form_validation->run() == true && $id = $this->ion_auth->register($username, $password, $email, $additional_data)) {
            ...
            redirect("auth/personal_details");
        } else {
    ...
    public function personal_details() {
        ...
        $this->layout->view('auth/personal_details', $this->data);
    }
    
    public function recommend_friend() {
        $this->data['message'] = '';
        $this->data['friend_name'] = array(
            'name' => 'friend_name',
            'id' => 'friend_name',
            'type' => 'text',
            'class' => 'form-control',
            'value' => $this->form_validation->set_value('friend_name'),
        );
        $this->data['friend_email'] = array(
            'name' => 'friend_email',
            'id' => 'friend_email',
            'type' => 'text',
            'class' => 'form-control',
            'value' => $this->form_validation->set_value('friend_email'),
        );         
        $this->layout->view('auth/recommend_friend', $this->data);
    }
    
   public function interests() {        
        $this->layout->view('auth/interests');
    } 
    
   public function thanks() {        
        $this->layout->view('auth/thanks');
    }     
